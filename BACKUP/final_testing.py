...
def main():
    ...
    # Step B: Evaluate on original dataset after training on original data
    print("\nEvaluating on cifar 10 Dataset after training on Original Dataset")
    evaluate_model(model_original, test_dataloaders)
    
    # Step C: Train on the combined original + augmented dataset
    ...
    # Step D: Evaluate on original dataset after training on combined dataset
    print("\nEvaluating on cifar 10 Dataset after training on Combined Dataset")
    evaluate_model(model_original, test_dataloaders)
